...
struct Checker {
    ...
    pointer_views: HashMap<usize, hir::LowerPointerViewInfo>,
    ...
    for_element_plans: HashMap<usize, hir::DeepClonePlan>,
...
pub(crate) fn check(program: Program) -> AliasResult<hir::CheckedProgram> {
    ...
    hir::lower(
        ...
        hir::LowerFacts {
            ...
            pointer_views: ck.pointer_views,
            ...
            fors: ck.for_types,
            for_element_plans: ck.for_element_plans,
            for_ids: ck.for_ids,
